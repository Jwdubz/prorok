...
CAPTIONS = [
    ...
    "Peony sleeve, full view (healed).",
    "Floral charm and bell, angled view (healed).",
    "Crane and peony sleeve.",
    "Crane sleeve, inner view.",
    "Dragon backpiece.",
    "Red snake and cat sleeve (healed).",
    "Snake and peony sleeve (healed).",
    "Peony and fox mask sleeve (healed).",
    "Peony and fox mask, extended view (healed).",
    "Frog procession.",
    "Dragon and Daruma sleeve (healed).",
    "Dragon and Daruma, inner view (healed).",
    "Geisha head with red flowers.",
    "Snake and peony thigh tattoo.",
    "Snake and peony, alternate view (healed).",
    "Black and grey dragon sleeve (healed).",
    "Skull-headed octopus.",
    "Black and grey tiger (healed).",
    "Color snake and peony.",
    "Hannya mask.",
    "Geisha portrait.",
    "Geisha and hannya pair (healed).",
